...
| V-171 | Final fail-closed acceptance aggregation | `build/quality/Test-FinalAcceptance.ps1`, `docs/build/quality/Test-FinalAcceptance.ps1.md` | verified as a schema-aware fail-closed gate, including exact installer case IDs and strict Stage A references; current invocation is blocked because all nine environment/integration artifacts are absent |
