...
| V-167 | MFT performance matrix | `MftBenchmarks`, `Test-FullBenchmarkMatrix.ps1` | gate now validates the required per-run dataset/candidate/detail-query/drop/environment oracle; connected evidence and dedicated labeled-volume run remain pending |
